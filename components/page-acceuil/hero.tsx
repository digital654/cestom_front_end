export default function Hero() {
   ...
   <div className="w-full h-full flex items-center justify-center z-10">
    <h1 className="md:text-7xl text-6xl md:-mt-65 -mt-100  font-bold flex text-center flex-col items-center justify-center font-mono italic   text-white absolute z-10">Bienvenue a Cestom <span className="font-mono italic">Digital</span></h1>
